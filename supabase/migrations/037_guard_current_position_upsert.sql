-- Prevent stale telemetry from overwriting the current live position.
-- Historical rows are still inserted, but vehicle_positions keeps the newest recorded_at.
