/**
 * Aplica migracion 037 (proteccion contra posiciones actuales obsoletas).
 * Uso: node scripts/apply-migrations-037.mjs [DB_PASSWORD]
 */
...
const migrations = [
  '037_guard_current_position_upsert.sql',
]
