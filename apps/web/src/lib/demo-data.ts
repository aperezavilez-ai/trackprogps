import type { DashboardStats, LiveVehicle, Alert, Vehicle } from '@gps-saas/types'
...
export const DEMO_VEHICLES_TABLE: Vehicle[] = [
  {
    ...
    position: [{ lat: 19.4326, lng: -99.1332, speed: 72, ignition: true, recorded_at: new Date().toISOString() }] as never,
  },
  {
    id: 'v2', company_id: 'demo-company-id', economic_num: 'ECO-002',
    plates: 'XYZ-789-B', brand: 'Freightliner', model: 'Cascadia', year: 2021,
    color: 'Rojo', vin: '3AKJGLDRXKSKF9999', status: 'active',
    ...
    position: [{ lat: 19.42, lng: -99.15, speed: 0, ignition: true, recorded_at: new Date().toISOString() }] as never,
  },
  {
    id: 'v3', company_id: 'demo-company-id', economic_num: 'ECO-003',
    plates: 'DEF-456-C', brand: 'International', model: 'ProStar', year: 2020,
    color: 'Azul', vin: '1HTMSTAR0LH600001', status: 'active',
    ...
    position: [{ lat: 19.44, lng: -99.17, speed: 55, ignition: true, recorded_at: new Date().toISOString() }] as never,
  },
  {
    id: 'v4', company_id: 'demo-company-id', economic_num: 'ECO-004',
    plates: 'GHI-321-A', brand: 'Peterbilt', model: '389', year: 2023,
    color: 'Negro', vin: '1XPBDK9X7RD654321', status: 'maintenance',
  ...
  },
  {
    ...
    color: 'Blanco', vin: 'YV2RT40A1NA000001', status: 'active',
    ...
    position: [{ lat: 19.46, lng: -99.12, speed: 90, ignition: true, recorded_at: new Date().toISOString() }] as never,
  },
  {
    id: 'v6', company_id: 'demo-company-id', economic_num: 'ECO-006',
    plates: 'MNO-987-F', brand: 'Mercedes-Benz', model: 'Actros', year: 2018,
    color: 'Gris', vin: 'WDB9634031L000001', status: 'active',
